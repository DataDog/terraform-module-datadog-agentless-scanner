...
|------|-------------|------|---------|:--------:|
| <a name="input_api_key_secret_ids"></a> [api\_key\_secret\_ids](#input\_api\_key\_secret\_ids) | List of Secret Manager secret identifiers containing the Datadog API keys in the format projects/[project\_id]/secrets/[secret\_name] | `list(string)` | n/a | yes |
