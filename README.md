...
| <a name="input_scanner_version"></a> [scanner\_version](#input\_scanner\_version) | Version of the scanner to install. Ignored when scanner\_channel is "nightly", which always installs the latest available nightly build. | `string` | `"0.11"` | no |
