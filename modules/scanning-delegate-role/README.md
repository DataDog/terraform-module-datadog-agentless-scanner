...
| <a name="input_scanner_organization_unit_ids"></a> [scanner\_organization\_unit\_ids](#input\_scanner\_organization\_unit\_ids) | List of AWS Organizations organizational units (OUs) allowed to assume this role | `list(string)` | <pre>[<br>  "*"<br>]</pre> | no |
