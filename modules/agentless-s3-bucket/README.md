...
|------|-------------|------|---------|:--------:|
| <a name="input_iam_delegate_role_arn"></a> [iam\_delegate\_role\_arn](#input\_iam\_delegate\_role\_arn) | Reference ARN to the Agentless delegate role | `string` | n/a | yes |
| <a name="input_iam_rds_assume_role_arn"></a> [iam\_rds\_assume\_role\_arn](#input\_iam\_rds\_assume\_role\_arn) | Reference ARN to the Agentless RDS assume role | `string` | n/a | yes |
